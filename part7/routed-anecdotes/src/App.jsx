...
const Anecdote = ({ anecdote, handleClick, setNotification }) => (
  <>
...
const About = () => (
  <div>
    ...
    <em>
      ...
      anecdote is &apos a story with a point.&apos
    </em>
    ...
    <div>
      ...
      <Routes>
        ...
        <Route
          path='/anecdotes/:id'
          element={
            <Anecdote anecdote={anecdote} handleClick={vote} setNotification={setNotification} />
          }
        />
      </Routes>
      <Footer />
