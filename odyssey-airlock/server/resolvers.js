...
const resolvers = {
  Query: {
    ...
    listingAmenities: (_, __, { dataSources }) =>
      dataSources.listingsAPI.getAllAmenities(),
  ...
  Host: {
    overallRating: ({ id }, _, { dataSources }) =>
      dataSources.reviewsDb.getOverallRatingForHost(id),
  },
  Guest: {
  ...
  Listing: {
    host: ({ hostId }, _, { dataSources }) =>
      dataSources.accountsAPI.getUser(hostId),
    overallRating: ({ id }, _, { dataSources }) =>
      dataSources.reviewsDb.getOverallRatingForListing(id),
    reviews: ({ id }, _, { dataSources }) =>
      dataSources.reviewsDb.getReviewsForListing(id),
    totalCost: async (
      { id },
    ...
    currentlyBookedDates: ({ id }, _, { dataSources }) =>
      dataSources.bookingsDb.getCurrentlyBookedDateRangesForListing(id),
    bookings: ({ id }, _, { dataSources }) =>
      dataSources.bookingsDb.getBookingsForListing(id),
  ...
  Booking: {
    listing: ({ listingId }, _, { dataSources }) =>
      dataSources.listingsAPI.getListing(listingId),
    checkInDate: ({ checkInDate }, _, { dataSources }) =>
      dataSources.bookingsDb.getHumanReadableDate(checkInDate),
    checkOutDate: ({ checkOutDate }, _, { dataSources }) =>
      dataSources.bookingsDb.getHumanReadableDate(checkOutDate),
    guest: ({ guestId }, _, { dataSources }) =>
      dataSources.accountsAPI.getUser(guestId),
    totalPrice: async (
    ...
    guestReview: ({ id }, _, { dataSources }) =>
      dataSources.reviewsDb.getReviewForBooking('GUEST', id),
    hostReview: ({ id }, _, { dataSources }) =>
      dataSources.reviewsDb.getReviewForBooking('HOST', id),
    locationReview: ({ id }, _, { dataSources }) =>
      dataSources.reviewsDb.getReviewForBooking('LISTING', id),
  },
  Review: {
    author: ({ authorId }, _, { dataSources }) =>
      dataSources.accountsAPI.getUser(authorId),
  },
  AmenityCategory: {
